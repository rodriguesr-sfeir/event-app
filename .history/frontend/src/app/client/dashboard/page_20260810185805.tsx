            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <p className="text-slate-600 font-medium">Évènements</p>
                  <svg className="w-8 h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                </div>
                <p className="text-3xl font-bold text-slate-900">{stats.eventCount}</p>
                <p className="text-slate-500 text-sm mt-1">Nombre total d'Évènement(s) actif(s)</p>
              </div>
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-6">
                ...
                <p className="text-slate-500 text-sm mt-1">Nombre de photo(s) partagée(s)</p>
              </div>
...
<div className="bg-white rounded-lg border border-slate-200 p-6">
  ...
  <p className="text-slate-500 text-sm mt-1">Nombre de contributeur(s)</p>
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-6">
                ...
                <p className="text-slate-500 text-sm mt-1">Nombre total d'évènement(s) ce mois</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-200">
                <h2 className="text-lg font-bold text-slate-900">Évènements</h2>
              </div>
