            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white rounded-lg border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <svg className="w-5 h-5 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-2a6 6 0 0112 0v2zm6 0h-2v-5.5a3.5 3.5 0 00-7 0V21h-2v-2a5 5 0 0110 0v2z" />
                  </svg>
                </div>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              <Link
                                ...
                                className="p-2 hover:bg-blue-100 rounded-lg transition text-slate-600"
                                title="Accéder"
                              >
                                ↗
                              </Link>
                              ...
                              <button
                                ...
                                className="p-2 hover:bg-red-100 rounded-lg transition disabled:opacity-50 text-slate-600"
                                title="Supprimer"
                              >
                                {deletingId === event.id ? '⏳' : '×'}
                              </button>
